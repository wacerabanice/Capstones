...
Enchepata App is a web-based investment guide that allows users to learn about stocks, track live prices, and calculate potential returns from the FSC API. This project demonstrates practical React skills, state management, API integration, and responsive design.
